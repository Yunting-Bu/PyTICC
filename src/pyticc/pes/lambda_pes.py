...
def as_lambda_pes(pes: PESWrapper) -> LambdaPES:
    ...
    return LambdaPES(interaction=interaction, monomer_Y=pes.monomer_Y, interaction_many=interaction_many, _close=pes.close)
...
def get_lambda_grid_atom_diatom(
    ...
    return _evaluate_lambda(pes, R, coordinates, grids[0].shape)
